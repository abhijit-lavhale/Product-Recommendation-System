...
model = joblib.load(r"C:\Users\abhij\Product recommendation system\knn_basics_model.pkl")
...
with col1:
    st.image("C:\\Users\\abhij\\Product recommendation system\\item_pic.jpg")  # Replace with your logo or image URL
